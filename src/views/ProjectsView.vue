...
import { Divider, Panel, Button } from 'primevue'
</script>
...
<template class="flex flex-col h-screen justify-center items-center">
  ...
  >
    ...
    <p class="text-lg">
      Here are some of the projects that I've worked on in the past. Feel free to check them out and
    ...
    <div class="grid gap-4">
      <Panel header="Solstice" toggleable>
        <div class="flex flex-col w-full gap-4">
          <p class="text-lg">
            ...
            Solstice was built as part of a course module, User Centred Web Development,
            which covered the importance of user experience and accessibility when designing a product. 
            The development of this application followed the principles of Design Sprints, a methodology used to quickly validate ideas and solve challenges.
          </p>
          <Button
            as="a"
            label="View code"
      ...
      <Panel header="Parcel Delivery Module" toggleable>
        <div class="flex flex-col w-full gap-4">
          <p class="text-lg">
            Created as part of a university module on large enterprise systems, I developed a microservices module that handles and manages the delivery of parcels for a fictional shoe company.
          </p>
          <Button
            as="a"
            label="View code"
